...
export const FIELD_INFO = {
  ...
  op3: "Enable OP3 (Open Podcast Prefix Project) analytics. Adds a transparent prefix to track URLs for open, privacy-respecting download stats. Free, no signup required. Stats available at op3.dev/show/<your-podcast-guid>.",
